        ...
        >
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            <Nav className="ms-auto">
              <Nav.Link style={{ color: "white" }} onClick={handleHome}>
                Home
              </Nav.Link>
              <Nav.Link onClick={handleAboutus} style={{ color: "white" }}>
                About Us
              </Nav.Link>
              <NavDropdown
                title={
              ...
              >
                ...
                >
                  <NavDropdown.Item onClick={handleInbountreceipt}>
                    Inbound Receipt
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleCrossdocking}>
                    Cross Docking
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleDeconsolidation}>
                    Deconsolidation
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleQualityassurance}>
                    Quality Assurance
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleRepackingPutaway}>
                    Repacking & Putaway
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handlePickmanagement}>
                    Pick Management
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleDispatch}>
                    Dispatch
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleInventorymanagement}>
                    Inventory Management
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleApiintegration}>
                    API Integration
                  </NavDropdown.Item>
                  <NavDropdown.Item onClick={handleIOTIntegration}>
                    IOT Integration
                  </NavDropdown.Item>
                </NavDropdown>

                <NavDropdown title="Sales" id="basic-nav-dropdown-sales">
                  <NavDropdown.Item href="#order-management">
                    Order Management
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#quotation-management">
                    Quotation Management
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#returns-management">
                    Returns Management
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#process-management">
                    Process Management
                  </NavDropdown.Item>
                </NavDropdown>
                ...
                <NavDropdown
                  ...
                  id="basic-nav-dropdown-ai"
                >
                  <NavDropdown.Item href="#multi-channel-integration">
                    Multi-Channel Integration
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#order-management-system">
                    Order Management System
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#pick-list-generation">
                    Pick List Generation
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#pick-sequencing">
                    Pick Sequencing
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#work-force-management">
                    Work Force Management
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#packing-shipping">
                    Packing And Shipping
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#fulfillment-validation">
                    Fulfillment Validation
                  </NavDropdown.Item>
                  <NavDropdown.Item href="#e-commerce-integration">
